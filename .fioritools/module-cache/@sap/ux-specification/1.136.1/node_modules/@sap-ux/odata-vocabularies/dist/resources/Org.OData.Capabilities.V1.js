...
exports.default = {
    ...
    'Org.OData.Capabilities.V1': {
        ...
        'IsolationLevel': {
            ...
            '$IsFlags': true,
            'Snapshot': 1,
            'Snapshot@Org.OData.Core.V1.Description': 'All data returned for a request, including multiple requests within a batch or results retrieved across multiple pages, will be consistent as of a single point in time'
        },
        'CrossJoinSupported': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
        ...
        'ChangeTrackingType': {
            ...
            'FilterableProperties': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'If no properties are specified or FilterableProperties is omitted, clients cannot assume support for filtering on any properties in combination with change tracking.'
            },
            'ExpandableProperties': {
                '$Collection': true,
                '$Type': 'Edm.NavigationPropertyPath',
                '@Org.OData.Core.V1.Description': 'Change tracking supports these properties expanded',
                '@Org.OData.Core.V1.LongDescription': 'If no properties are specified or ExpandableProperties is omitted, clients cannot assume support for expanding any properties in combination with change tracking.'
            }
        },
        'CountRestrictions': {
            '$Kind': 'Term',
        ...
        'NavigationRestrictionsType': {
            ...
            'Navigability': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Default navigability for all navigation properties of the annotation target. Individual navigation properties can override this value via `RestrictedProperties/Navigability`.'
            },
        ...
        'NavigationPropertyRestriction': {
            ...
            'FilterFunctions': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'If not specified, null, or empty, all functions and operators may be attempted.'
            },
            'FilterRestrictions': {
            ...
            'DeepInsertSupport': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Deep Insert Support of the annotated resource (the whole service, an entity set, or a collection-valued resource)'
            },
            'UpdateRestrictions': {
            ...
            'DeepUpdateSupport': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Deep Update Support of the annotated resource (the whole service, an entity set, or a collection-valued resource)'
            },
            'DeleteRestrictions': {
            ...
            'OptimisticConcurrencyControl': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'Data modification (including insert) along this navigation property requires the use of ETags'
            },
            'ReadRestrictions': {
                ...
                '@Org.OData.Validation.V1.AllowedValues': [
                    {
                        ...
                        '@Org.OData.Core.V1.Description': '[Multipart Batch Format](http://docs.oasis-open.org/odata/odata/v4.01/cs01/part1-protocol/odata-v4.01-cs01-part1-protocol.html#sec_MultipartBatchFormat)'
                    },
                    {
                        'Value': 'application/json',
                        '@Org.OData.Core.V1.Description': '[JSON Batch Format](http://docs.oasis-open.org/odata/odata-json-format/v4.01/cs01/odata-json-format-v4.01-cs01.html#sec_BatchRequestsandResponses)'
                    }
                ]
            }
        },
        ...
        'FilterRestrictionsBase': {
            ...
            'MaxLevels': {
                '$Type': 'Edm.Int32',
                '$DefaultValue': -1,
                '@Org.OData.Core.V1.Description': 'The maximum number of levels (including recursion) that can be traversed in a filter expression. A value of -1 indicates there is no restriction.'
            }
        },
        'FilterRestrictionsType': {
            ...
            'FilterExpressionRestrictions': {
                ...
                '@Org.OData.Core.V1.Description': 'These properties only allow a subset of filter expressions. A valid filter expression for a single property can be enclosed in parentheses and combined by `and` with valid expressions for other properties.'
            }
        },
        ...
        'FilterExpressionType': {
            ...
            '@Org.OData.Validation.V1.AllowedValues': [
                ...
                {
                    'Value': 'MultiValue',
                    '@Org.OData.Core.V1.Description': 'Property can be used in multiple `eq` and `in` clauses, combined by `or` (which is logically equivalent to a single `in` clause)'
                },
                {
                    'Value': 'SingleRange',
                    '@Org.OData.Core.V1.Description': 'Property can be compared to a single closed, half-open, or open interval',
                    '@Org.OData.Core.V1.LongDescription': 'The filter expression for this property consists of a single interval expression, which is either a single comparison of the property and a literal value with `eq`, `le`, `lt`, `ge`, or `gt`, or a pair of boundaries combined by `and`. The lower boundary is either `ge` or `gt`, the upper boundary either `le` or `lt`.'
                },
                {
                    'Value': 'MultiRange',
                    '@Org.OData.Core.V1.Description': 'Property can be compared to a union of one or more closed, half-open, or open intervals',
                    '@Org.OData.Core.V1.LongDescription': 'The filter expression for this property consists of one or more interval expressions, combined by `or`. See SingleRange for the definition of an interval expression.\n\n                Alternatively the filter expression can consist of one or more `ne` expressions combined by `and`, which is roughly equivalent to the union of the complementing open intervals. Roughly equivalent because `null` is allowed as a right-side operand of an `ne` expression.'
                },
                {
                    'Value': 'SearchExpression',
                    '@Org.OData.Core.V1.Description': 'String property can be used as first operand in `startswith`, `endswith`, and `contains` clauses'
                },
                {
                    'Value': 'MultiRangeOrSearchExpression',
                    '@Org.OData.Core.V1.Description': 'Property can be compared to a union of zero or more closed, half-open, or open intervals plus zero or more simple string patterns',
                    '@Org.OData.Core.V1.LongDescription': 'The filter expression for this property consists of one or more interval expressions or string comparison functions combined by `or`. See SingleRange for the definition of an interval expression. See SearchExpression for the allowed string comparison functions.'
                }
            ]
        },
        'SortRestrictions': {
        ...
        'ExpandRestrictionsBase': {
            ...
            'MaxLevels': {
                '$Type': 'Edm.Int32',
                '$DefaultValue': -1,
                '@Org.OData.Core.V1.Description': 'The maximum number of levels that can be expanded in a expand expression. A value of -1 indicates there is no restriction.'
            }
        },
        ...
        'KeyAsSegmentSupported': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['EntityContainer'],
            '@Org.OData.Core.V1.Description': 'Supports [key-as-segment convention](http://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part2-url-conventions.html#sec_KeyasSegmentConvention) for addressing entities within a collection'
        },
        'QuerySegmentSupported': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['EntityContainer'],
            '@Org.OData.Core.V1.Description': 'Supports [passing query options in the request body](http://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part2-url-conventions.html#sec_PassingQueryOptionsintheRequestBody)'
        },
        'InsertRestrictions': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Capabilities.V1.InsertRestrictionsType',
        ...
        'InsertRestrictionsBase': {
            ...
            'MaxLevels': {
                '$Type': 'Edm.Int32',
                '$DefaultValue': -1,
                '@Org.OData.Core.V1.Description': 'The maximum number of navigation properties that can be traversed when addressing the collection to insert into. A value of -1 indicates there is no restriction.'
            },
            'TypecastSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Entities of a specific derived type can be created by specifying a type-cast segment'
            },
            'QueryOptions': {
        ...
        'InsertRestrictionsType': {
            ...
            'Permissions': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Required permissions. One of the specified sets of scopes is required to perform the insert.'
            }
        },
        'PermissionType': {
            '$Kind': 'ComplexType',
        ...
        'ScopeType': {
            ...
            'RestrictedProperties': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Comma-separated string value of all properties that will be included or excluded when using the scope.',
                '@Org.OData.Core.V1.LongDescription': 'Possible string value identifiers when specifying properties are `*`, _PropertyName_, `-`_PropertyName_.\n\n`*` denotes all properties are accessible.\n\n`-`_PropertyName_ excludes that specific property.\n\n_PropertyName_ explicitly provides access to the specific property.\n\nThe absence of `RestrictedProperties` denotes all properties are accessible using that scope.'
            }
        },
        'DeepInsertSupport': {
            '$Kind': 'Term',
        ...
        'DeepInsertSupportType': {
            ...
            'ContentIDSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Annotation target supports accepting and returning nested entities annotated with the `Core.ContentID` instance annotation.'
            }
        },
        'UpdateRestrictions': {
            '$Kind': 'Term',
        ...
        'UpdateRestrictionsBase': {
            ...
            'DeltaUpdateSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'Entities can be inserted, updated, and deleted via a PATCH request with a delta payload'
            },
            'UpdateMethod': {
                '$Type': 'Org.OData.Capabilities.V1.HttpMethod',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Supported HTTP Methods (PUT or PATCH) for updating an entity.  If null, PATCH SHOULD be supported and PUT MAY be supported.'
            },
            'FilterSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Members of collections can be updated via a PATCH request with a `/$filter(...)/$each` segment'
            },
            'TypecastSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Members of collections can be updated via a PATCH request with a type-cast segment and a `/$each` segment'
            },
            'MaxLevels': {
                '$Type': 'Edm.Int32',
                '$DefaultValue': -1,
                '@Org.OData.Core.V1.Description': 'The maximum number of navigation properties that can be traversed when addressing the collection or entity to update. A value of -1 indicates there is no restriction.'
            },
            'Permissions': {
                '$Collection': true,
                '$Type': 'Org.OData.Capabilities.V1.PermissionType',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Required permissions. One of the specified sets of scopes is required to perform the update.'
            },
            'QueryOptions': {
                '$Type': 'Org.OData.Capabilities.V1.ModificationQueryOptionsType',
                '$Nullable': true,
        ...
        'DeleteRestrictionsBase': {
            ...
            'MaxLevels': {
                '$Type': 'Edm.Int32',
                '$DefaultValue': -1,
                '@Org.OData.Core.V1.Description': 'The maximum number of navigation properties that can be traversed when addressing the collection to delete from or the entity to delete. A value of -1 indicates there is no restriction.'
            },
            'FilterSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Members of collections can be deleted via a DELETE request with a `/$filter(...)/$each` segment'
            },
            'TypecastSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Members of collections can be deleted via a DELETE request with a type-cast segment and a `/$each` segment'
            },
            'Permissions': {
                '$Collection': true,
                '$Type': 'Org.OData.Capabilities.V1.PermissionType',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Required permissions. One of the specified sets of scopes is required to perform the delete.'
            },
            'CustomHeaders': {
                '$Collection': true,
                '$Type': 'Org.OData.Capabilities.V1.CustomParameter',
        ...
        'CollectionPropertyRestrictions': {
            ...
            '@Org.OData.Core.V1.Description': 'Describes restrictions on operations applied to collection-valued structural properties'
        },
        'CollectionPropertyRestrictionsType': {
            ...
            'Insertable': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'If additionally annotated with [Core.PositionalInsert](Org.OData.Core.V1.md#PositionalInsert), members can be inserted at a specific position'
            },
            'Updatable': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
        ...
        'OperationRestrictionsType': {
            ...
            'FilterSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Bound action or function can be invoked on a collection-valued binding parameter path with a `/$filter(...)` segment'
            },
            'Permissions': {
                '$Collection': true,
                '$Type': 'Org.OData.Capabilities.V1.PermissionType',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Required permissions. One of the specified sets of scopes is required to invoke an action or function'
            },
            'CustomHeaders': {
                '$Collection': true,
                '$Type': 'Org.OData.Capabilities.V1.CustomParameter',
        ...
        'ModificationQueryOptions': {
            ...
            '@Org.OData.Core.V1.Description': 'Support for query options with modification requests (insert, update, action invocation)'
        },
        ...
        'ReadRestrictions': {
            ...
            '$AppliesTo': ['EntitySet', 'Singleton', 'Collection'],
            '@Org.OData.Core.V1.AppliesViaContainer': true,
            '@Org.OData.Core.V1.Description': 'Restrictions for retrieving a collection of entities, retrieving a singleton instance.'
        },
        'ReadRestrictionsBase': {
            ...
            'Permissions': {
                ...
                '$Type': 'Org.OData.Capabilities.V1.PermissionType',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Required permissions. One of the specified sets of scopes is required to read.'
            },
            'CustomHeaders': {
                '$Collection': true,
                '$Type': 'Org.OData.Capabilities.V1.CustomParameter',
        ...
        'ReadRestrictionsType': {
            ...
            'TypecastSegmentSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Entities of a specific derived type can be read by specifying a type-cast segment'
            },
            'ReadByKeyRestrictions': {
                '$Type': 'Org.OData.Capabilities.V1.ReadByKeyRestrictionsType',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Restrictions for retrieving an entity by key',
                '@Org.OData.Core.V1.LongDescription': 'Only valid when applied to a collection. If a property of `ReadByKeyRestrictions` is not specified, the corresponding property value of `ReadRestrictions` applies.'
            }
        },
        'CustomHeaders': {
            '$Kind': 'Term',
        ...
        'CustomQueryOptions': {
            ...
            '$Type': 'Org.OData.Capabilities.V1.CustomParameter',
            '$AppliesTo': ['EntityContainer'],
            '@Org.OData.Core.V1.Description': 'Custom query options that are supported/required for the annotated resource',
            '@Org.OData.Core.V1.LongDescription': 'If the entity container is annotated, the query option is supported/required by all resources in that container.',
            '@Org.OData.Core.V1.Example': {
        ...
        'CustomParameter': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The type of a custom parameter is always a string. Restrictions on the parameter values can be expressed by annotating the record expression describing the parameter with terms from the Validation vocabulary, e.g. Validation.Pattern or Validation.AllowedValues.',
            'Name': {
            ...
            'Required': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': 'true: parameter is required, false or not specified: parameter is optional'
            },
            'ExampleValues': {
                '$Collection': true,
        ...
        'MediaLocationUpdateSupported': {
            ...
            '@Org.OData.Core.V1.Description': 'Stream property or media stream supports update of its media edit URL and/or media read URL'
        },
        'DefaultCapabilities': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Capabilities.V1.DefaultCapabilitiesType',
            '$AppliesTo': ['EntityContainer'],
            '@Org.OData.Core.V1.Description': 'Default capability settings for all collection-valued resources in the container',
            '@Org.OData.Core.V1.LongDescription': 'Annotating a specific capability term, which is included as property in `DefaultCapabilitiesType`, for a specific collection-valued resource overrides the default capability with the specified properties using PATCH semantics:\n- Primitive or collection-valued properties specified in the specific capability term replace the corresponding properties specified in `DefaultCapabilities`\n- Complex-valued properties specified in the specific capability term override the corresponding properties specified in `DefaultCapabilities` using PATCH semantics recursively\n- Properties specified neither in the specific term nor in `DefaultCapabilities` have their default value'
        },
...
//# sourceMappingURL=Org.OData.Capabilities.V1.js.map