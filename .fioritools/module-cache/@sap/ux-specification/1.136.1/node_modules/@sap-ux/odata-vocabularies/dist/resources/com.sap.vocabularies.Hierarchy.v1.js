...
exports.default = {
    ...
    'com.sap.vocabularies.Hierarchy.v1': {
        ...
        'RecursiveHierarchy': {
            ...
            '@Org.OData.Core.V1.Description': 'Hierarchy-specific information in the result set of a hierarchical request',
            '@Org.OData.Core.V1.LongDescription': 'The [base term](https://oasis-tcs.github.io/odata-vocabularies/vocabularies/Org.OData.Aggregation.V1.html#RecursiveHierarchy)\n          governs what are the nodes and parents in the hierarchy, whereas this term defines derived information.'
        },
        'HierarchyType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.LongDescription': 'The properties in this complex type contain information about\n          an entry in the result set of a request with multiple aggregation levels, some of which are expanded.\n          These properties also serve in the derived [`RecursiveHierarchyType`](#RecursiveHierarchyType)\n          with their definitions rephrased in the concept of recursive hierarchies.',
            'LimitedDescendantCount': {
                '$Type': 'Edm.Int64',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Number of entries from finer-grained aggregation levels that are expanded'
            },
            'DrillState': {
                '$Nullable': true,
                ...
                '@Org.OData.Validation.V1.AllowedValues': [
                    {
                        'Value': 'expanded',
                        '@Org.OData.Core.V1.Description': 'The entry precedes entries from finer-grained aggregation levels'
                    },
                    {
                        'Value': 'subtotal',
                        '@com.sap.vocabularies.Common.v1.Experimental': true,
                        '@Org.OData.Core.V1.Description': 'The entry follows entries from finer-grained aggregation levels and contains subtotals'
                    },
                    {
                        'Value': 'leaf',
                    ...
                    {
                        'Value': 'collapsed',
                        '@Org.OData.Core.V1.Description': 'The entry belongs to an aggregation level coarser than the finest-grained but is neither expanded nor subtotal'
                    }
                ]
            },
            'DistanceFromRoot': {
                '$Type': 'Edm.Int64',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Position of the current aggregation level in the list of all aggregation levels'
            }
        },
        'RecursiveHierarchyType': {
            ...
            'DrillState': {
                ...
                '@Org.OData.Validation.V1.AllowedValues': [
                    ...
                    {
                        'Value': 'collapsed',
                        '@Org.OData.Core.V1.Description': 'The node has children in the unlimited hierarchy but not in the limited hierarchy'
                    },
                    {
                        'Value': 'leaf',
            ...
            'DistanceFromRoot': {
                '$Type': 'Edm.Int64',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Number of ancestors an occurrence of a node has in the limited hierarchy',
                '@Org.OData.Core.V1.LongDescription': 'This equals the number of ancestors in the sub-hierarchy, if the request involves a sub-hierarchy.'
            },
            'ChildCount': {
                '$Type': 'Edm.Int64',
                '$Nullable': true,
            ...
            'SiblingRank': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'The sibling rank of a node is the index of the node in the sequence of all nodes\n            in the unlimited hierarchy with the same parent. The first sibling has rank 0.'
            },
            'Matched': {
                '$Type': 'Edm.Boolean',
                '$Nullable': true,
            ...
            'MatchedDescendantCount': {
                ...
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Number of [matching](#MatchCount) descendants a node has in the unlimited hierarchy'
            }
        },
        ...
        'RecursiveHierarchyActionsType': {
            ...
            'CopyAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.OperationTemplate': 'com.sap.vocabularies.Hierarchy.v1.Template_CopyAction',
                '@Org.OData.Core.V1.Description': 'Action that copies a node and its descendants, following [this template](#Template_CopyAction)'
            }
        },
        'MatchCount': {
            '$Kind': 'Term',
        ...
        'TopLevels': [
            {
                ...
                '$Parameter': [
                    ...
                    {
                        '$Name': 'NodeProperty',
                        '@Org.OData.Core.V1.Description': 'Property path to the node identifier, evaluated relative to the binding parameter'
                    },
                    {
                        '$Name': 'Levels',
                        '$Type': 'Edm.Int64',
                        '@Org.OData.Core.V1.Description': 'The number n of levels to be output, absent means all levels',
        ...
        'TopLevelsExpandType': {
            ...
            'Levels': {
                '$Type': 'Edm.Int64',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Number of levels to be expanded, null means all levels, 0 means collapsed'
            }
        },
        'RecursiveHierarchySupported': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Whether the annotated collection acts as a [`RecursiveHierarchy`](#RecursiveHierarchy) with the given qualifier',
            '@Org.OData.Core.V1.LongDescription': 'This tag is applied to a collection with the same qualifier as the [`RecursiveHierarchy`](#RecursiveHierarchy) term which is applied to its entity type.\n          The recursive hierarchy can then only be addressed through a collection where this tag is true.'
        },
        'Template_ChangeNextSiblingAction': [
            {
                '$Kind': 'Action',
                '$IsBound': true,
                '@Org.OData.Core.V1.Description': 'Template for actions that move a node among its siblings and are named in [`RecursiveHierarchyActions/ChangeNextSiblingAction`](#RecursiveHierarchyActionsType)',
                '$Parameter': [
                    {
                        '$Name': 'Node',
                        '$Type': 'Edm.EntityType',
                    ...
                    },
                    {
                        ...
                        '$Nullable': true,
                        '@Org.OData.Core.V1.Description': "Key of the node's new next sibling S (null if the node shall become the last sibling)",
                        '@Org.OData.Core.V1.LongDescription': 'This parameter has properties with the same names, types, and type facets as the key properties of the entity type.\n            next(T) = S after the action.\n            If R is a node with next(R) = S before the action, then next(R) = T after the action, even if S = null.\n            It is an error if S has a different parent than T.'
                    }
                ]
            }
        ],
...
//# sourceMappingURL=com.sap.vocabularies.Hierarchy.v1.js.map