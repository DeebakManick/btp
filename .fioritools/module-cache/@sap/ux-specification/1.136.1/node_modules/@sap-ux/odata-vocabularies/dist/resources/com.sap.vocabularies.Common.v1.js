...
exports.default = {
    ...
    'com.sap.vocabularies.Common.v1': {
        ...
        'Experimental': {
            '$Kind': 'Term',
            '$Nullable': true,
            '@Org.OData.Core.V1.Description': 'Terms, types, and properties annotated with this term are experimental and can be changed incompatibly or removed completely any time without prior warning.',
            '@Org.OData.Core.V1.LongDescription': 'Do not use or rely on experimental terms, types, and properties in production environments.'
        },
        'ServiceVersion': {
            '$Kind': 'Term',
            '$Type': 'Edm.Int32',
            '$AppliesTo': ['Schema'],
            '@Org.OData.Core.V1.Description': '1 for first version of a service, incremented when schema changes incompatibly and service is published with a different URI'
        },
        'ServiceSchemaVersion': {
            '$Kind': 'Term',
            '$Type': 'Edm.Int32',
            '$AppliesTo': ['Schema'],
            '@Org.OData.Core.V1.Description': '0 for first schema version within a service version, incremented when schema changes compatibly'
        },
        'Label': {
            '$Kind': 'Term',
        ...
        'DocumentationRef': {
            ...
            '@Org.OData.Core.V1.Description': 'A URI referencing language-dependent documentation for the annotated model element',
        ...
        'Text': {
            ...
            '$Nullable': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'A descriptive text for values of the annotated property. Value MUST be a dynamic expression when used as metadata annotation.',
            '@Org.OData.Core.V1.IsLanguageDependent': true,
        ...
        'TextFor': {
            ...
            '@Org.OData.Core.V1.Description': 'The annotated property contains a descriptive text for values of the referenced property.'
        },
        'ExternalID': {
            '$Kind': 'Term',
            '$Nullable': true,
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'A human readable identifier for values of the annotated property or parameter. Value MUST be a dynamic expression when used as metadata annotation.',
            '@Org.OData.Core.V1.LongDescription': 'If the annotated property is (part of) a foreign key of a resource, the external id is a human readable (part of an) identifier of this resource.\n            There is a one-to-one relationship between each possible value of the annotated property and the corresponding external id.\n            The annotation of a parameter refers to a property of the operation binding parameter.'
        },
        'IsLanguageIdentifier': {
            ...
            '$AppliesTo': ['Property'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'An identifier to distinguish multiple texts in different languages for the same entity'
        },
        'TextFormat': {
            '$Kind': 'Term',
            '$Type': 'com.sap.vocabularies.Common.v1.TextFormatType',
            '$AppliesTo': ['Property', 'Parameter', 'ReturnType'],
            '@Org.OData.Core.V1.Description': 'The annotated property, parameter, or return type contains human-readable text that may contain formatting information',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String'
        },
        'TextFormatType': {
            '$Kind': 'EnumType',
            ...
            'html': 1,
            'html@Org.OData.Core.V1.Description': 'Plain text with markup that can validly appear directly within an HTML DIV element'
        },
        'Timezone': {
            '$Kind': 'Term',
            '$Nullable': true,
            '$AppliesTo': ['Property', 'Parameter'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'The point in time represented by the annotated property or parameter shall be interpreted in the given time zone',
            '@Org.OData.Core.V1.LongDescription': "Time zones shall be specified according to the [IANA](https://www.iana.org/time-zones) standard.\n            If this annotation is absent or null or an empty string, points in time are typically interpreted in the current user's or default time zone.\n            The annotation value can be a path expression resolving to a property that may be tagged with [`IsTimezone`](#IsTimezone).",
        ...
        'UnitSpecificPrecision': {
            ...
            '$AppliesTo': ['Property'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'The number of significant decimal digits of a currency amount or measured quantity',
        ...
        'DerivedNavigation': {
            ...
            '@Org.OData.Core.V1.Description': 'Shortcut for a multi-segment navigation, contains the long path with all its segments'
        },
        'Masked': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property contains sensitive data that should by default be masked on a UI and clear-text visible only upon user interaction',
            '@Org.OData.Core.V1.LongDescription': 'This tag affects only the presentation to the user.\n          The data are still transmitted in the response and can hence be observed using browser tools.'
        },
        'MaskedValue': {
            '$Kind': 'Term',
            '$Nullable': true,
            ...
            '@Org.OData.Core.V1.LongDescription': 'By default a masked property is excluded from responses and instead an instance annotation with this term is sent, containing a masked value that can be rendered by user interfaces.'
        },
        'RevealOnDemand': {
            '$Kind': 'Term',
            '$Type': 'Edm.Boolean',
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@com.sap.vocabularies.Common.v1.IsInstanceAnnotation': true,
            '@Org.OData.Core.V1.Description': 'Unmasked data for this property can be requested with custom query option `masked-values=false`'
        },
        'SemanticObject': {
            '$Kind': 'Term',
            '$Nullable': true,
            '$AppliesTo': ['EntitySet', 'EntityType', 'Property', 'NavigationProperty'],
            '@Org.OData.Core.V1.Description': 'Name of the Semantic Object represented as this entity type or identified by this property'
        },
        'SemanticObjectMapping': {
            ...
            '@Org.OData.Core.V1.Description': 'Maps properties of the annotated entity type or sibling properties of the annotated property to properties of the Semantic Object',
            '@Org.OData.Core.V1.LongDescription': 'This allows "renaming" of properties in the current context to match property names of the Semantic Object, e.g. `SenderPartyID` to `PartyID`. Only properties explicitly listed in the mapping are renamed, all other properties are available for intent-based navigation with their "local" name.'
        },
        'SemanticObjectMappingAbstract': {
            '$Kind': 'ComplexType',
            '$Abstract': true,
            '@Org.OData.Core.V1.Description': 'Maps a property of the Semantic Object to a property of the annotated entity type or a sibling property of the annotated property or a constant value',
        ...
        'SemanticObjectMappingType': {
            ...
            'LocalProperty': {
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Path to a local property that provides the value for the Semantic Object property'
            }
        },
        ...
        'SemanticObjectUnavailableActions': {
            ...
            '$AppliesTo': ['EntitySet', 'EntityType', 'Property'],
            '$BaseTerm': 'com.sap.vocabularies.Common.v1.SemanticObject',
            '@Org.OData.Core.V1.Description': 'List of actions that are not available in the current state of the instance of the Semantic Object'
        },
        'IsInstanceAnnotation': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Term'],
            '@Org.OData.Core.V1.Description': 'Term can also be used as instance annotation; AppliesTo of this term specifies where it can be applied'
        },
        ...
        'FilterExpressionType': {
            ...
            'SingleInterval': 2,
            'SingleInterval@Org.OData.Core.V1.Description': "at most one 'ge' and one 'le' clause, separated by 'and', alternatively a single 'eq' clause"
        },
        'FieldControl': {
            '$Kind': 'Term',
            ...
            '@Org.OData.Core.V1.Description': 'Control state of a property, parameter, or the media stream of a media entity',
            '@Org.OData.Core.V1.LongDescription': "This term can be used for static field control, providing an enumeration member value in $metadata, as well as dynamically, providing a `Path` expression.\n\nIn the dynamic case the property referenced by the `Path` expression MUST be of type `Edm.Byte` to accommodate OData V2 services as well as V4 infrastructures that don't support enumeration types.",
            '@com.sap.vocabularies.Common.v1.IsInstanceAnnotation': true
        },
        'FieldControlType': {
            '$Kind': 'EnumType',
        ...
        'Messages': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The name of the message type is service-specific, its structure components are identified by naming convention, following the names of the OData error response structure.\n\nThe minimum structure is\n- `code: Edm.String`\n- `message: Edm.String`\n- `target: Edm.String nullable`\n- `additionalTargets: Collection(Edm.String)`\n- `transition: Edm.Boolean`\n- `numericSeverity: Edm.Byte`\n- `longtextUrl: Edm.String nullable`\n          '
        },
        'additionalTargets': {
            '$Kind': 'Term',
            '$Collection': true,
            ...
            '@Org.OData.Core.V1.LongDescription': 'This instance annotation can be applied to the `error` object and the objects within the `details` array of an OData error response'
        },
        'longtextUrl': {
            '$Kind': 'Term',
            '$AppliesTo': ['Record'],
        ...
        'MaximumNumericMessageSeverity': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'The maximum severity of all end-user messages attached to an entity, null if no messages are attached',
            '@Org.OData.Core.V1.LongDescription': 'This metadata annotation can be applied to entity types that are also annotated with term [`Common.Messages`](#Messages)'
        },
        ...
        'IsActionCritical': {
            ...
            '@Org.OData.Core.V1.Description': "Criticality of the function or action to enforce a warning or similar before it's executed"
        },
        'Attributes': {
            '$Kind': 'Term',
            '$Collection': true,
            '$Type': 'Edm.PropertyPath',
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Attributes related to this property, which may occur in denormalized entity types'
        },
        'RelatedRecursiveHierarchy': {
            '$Kind': 'Term',
            '$Type': 'Edm.AnnotationPath',
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'A recursive hierarchy related to this property. The annotation path must end in Aggregation.RecursiveHierarchy.'
        },
        'Interval': {
            '$Kind': 'Term',
        ...
        'SAPObjectNodeType': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'SAP Object Node Types define the structure of SAP Object Types, which are a generalization of Business Object, Technical Object, Configuration Object, and Analytical Object.'
        },
        ...
        'Composition': {
            ...
            '$AppliesTo': ['NavigationProperty'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'The annotated navigation property represents a logical composition, even though it is non-containment',
            '@Org.OData.Core.V1.LongDescription': 'The entities related via this navigation property have an existential dependency on their composition parent. The entity set of the composition parent MUST contain a NavigationPropertyBinding for this navigation property.'
        },
        'SAPObjectNodeTypeReference': {
            '$Kind': 'Term',
            '$AppliesTo': ['Property'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'The entity referenced by the annotated property has the [`SAPObjectNodeType`](#SAPObjectNodeType) with this name',
            '@Org.OData.Core.V1.LongDescription': 'The entity containing the property and the entity referenced by it will in general have different SAP Object Node Types.'
        },
        'IsNaturalPerson': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.Tag',
            ...
            '@Org.OData.Core.V1.Description': 'The annotated entity type (e.g. `Employee`) or annotation (e.g. `IsImageUrl`) represents a natural person'
        },
        'ValueList': {
            '$Kind': 'Term',
            '$Type': 'com.sap.vocabularies.Common.v1.ValueListType',
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': 'Specifies how to get a list of acceptable values for a property or parameter',
            '@Org.OData.Core.V1.LongDescription': 'The value list can be based on user input that is passed in the value list request. The value list can be used for type-ahead and classical pick lists.'
        },
        'ValueListType': {
            '$Kind': 'ComplexType',
            ...
            'Label': {
                '$Nullable': true,
                '@Org.OData.Core.V1.IsLanguageDependent': true,
                '@Org.OData.Core.V1.Description': 'Headline for value list, fallback is the label of the property or parameter'
            },
            'CollectionPath': {
                '@Org.OData.Core.V1.Description': 'Resource path of an OData collection with possible values, relative to CollectionRoot'
            },
            'CollectionRoot': {
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Service root of the value list collection; not specified means local to the document containing the annotation'
            },
            'DistinctValuesSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@Org.OData.Core.V1.Description': "Indicates that the value list supports a 'distinct' aggregation on the value list properties defined via ValueListParameterInOut and ValueListParameterOut"
            },
            'SearchSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': true,
                '@Org.OData.Core.V1.Description': 'Value list supports the $search query option',
                '@Org.OData.Core.V1.LongDescription': 'The value of the target property is used as the search expression instead of in $filter'
            },
            'FetchValues': {
            ...
            'PresentationVariantQualifier': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'Qualifier for annotation with term [UI.PresentationVariant](UI.md#PresentationVariant) on the entity set identified via CollectionPath'
            },
            'SelectionVariantQualifier': {
                '$Type': 'Org.OData.Core.V1.SimpleIdentifier',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Optional combination of parameters and filters to query the value help entity set',
                '@Org.OData.Core.V1.LongDescription': 'Qualifier for annotation with term [UI.SelectionVariant](UI.md#SelectionVariant) on the entity set identified via CollectionPath'
            },
            'Parameters': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.Common.v1.ValueListParameter',
                '@Org.OData.Core.V1.Description': 'Instructions on how to construct the value list request and consume response properties'
            }
        },
        'FetchValuesType': {
            '$Kind': 'TypeDefinition',
        ...
        'ValueListRelevantQualifiers': {
            ...
            '@Org.OData.Core.V1.LongDescription': 'The value of this annotation is a dynamic expression for calculating the qualifiers of relevant value lists depending on the values of one or more other properties.'
        },
        'ValueListWithFixedValues': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': "If specified as true, there's only one value list mapping and its value list consists of a small number of fixed values",
        ...
        'ValueListShowValuesImmediately': {
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'A value list with a very small number of fixed values, can decide to show all values immediately'
        },
        'ValueListForValidation': {
            '$Kind': 'Term',
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': 'Contains the qualifier of the ValueList or ValueListMapping that should be used for validation',
            '@Org.OData.Core.V1.LongDescription': 'An empty string identifies the ValueList or ValueListMapping without a qualifier.'
        },
        'ValueListReferences': {
            '$Kind': 'Term',
            '$Collection': true,
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.IsURL': true,
            '@Org.OData.Core.V1.Description': 'A list of URLs of CSDL documents containing value list mappings for this parameter or property'
        },
        'ValueListMapping': {
            '$Kind': 'Term',
            '$Type': 'com.sap.vocabularies.Common.v1.ValueListMappingType',
            '$AppliesTo': ['Property', 'Parameter'],
            '@Org.OData.Core.V1.Description': 'Specifies the mapping between data service properties and value list properties',
            '@Org.OData.Core.V1.LongDescription': 'The value list can be filtered based on user input. It can be used for type-ahead and classical pick lists. There may be many alternative mappings with different qualifiers.'
        },
        'ValueListMappingType': {
            ...
            'CollectionPath': {
                '@Org.OData.Core.V1.Description': 'Resource path of an OData collection with possible values, relative to the document containing the value list mapping'
            },
            'DistinctValuesSupported': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
            ...
            'PresentationVariantQualifier': {
                ...
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Alternative representation of a value help, e.g. as a bar chart',
                '@Org.OData.Core.V1.LongDescription': 'Qualifier for annotation with term [UI.PresentationVariant](UI.md#PresentationVariant) on the value list entity set identified via CollectionPath in the ValueListReference annotation'
            },
            'SelectionVariantQualifier': {
                '$Type': 'Org.OData.Core.V1.SimpleIdentifier',
                '$Nullable': true,
        ...
        'ValueListParameter': {
            ...
            '$Abstract': true,
            'ValueListProperty': {
                '@Org.OData.Core.V1.Description': 'Path to property in the value list . Format is identical to PropertyPath annotations.'
            }
        },
        'ValueListParameterIn': {
            ...
            'LocalDataProperty': {
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Path to property that is used to filter the value list with `eq` comparison',
                '@Org.OData.Core.V1.LongDescription': 'In case the property path contains a collection-based navigation or structural property, the filter is a set of `eq` comparisons connected by `or` operators'
            },
        ...
        'ValueListParameterConstant': {
            ...
            'Constant': {
                '$Type': 'Edm.PrimitiveType',
                '@Org.OData.Core.V1.Description': 'Constant value that is used to filter the value list with `eq` comparison, using the same representation as property default values, see [CSDL XML, 7.2.7 Default Value](https://docs.oasis-open.org/odata/odata-csdl-xml/v4.01/odata-csdl-xml-v4.01.html#sec_DefaultValue)'
            },
            'InitialValueIsSignificant': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
        ...
        'ValueListParameterConstants': {
            ...
            'Constants': {
                '$Collection': true,
                '$Type': 'Edm.PrimitiveType',
                '@Org.OData.Core.V1.Description': 'List of constant values that are used to filter the value list with `eq` comparisons connected by `or` operators, using the same representation as property default values, see [CSDL XML, 7.2.7 Default Value](https://docs.oasis-open.org/odata/odata-csdl-xml/v4.01/odata-csdl-xml-v4.01.html#sec_DefaultValue). Initial values are significant.',
        ...
        'ValueListParameterInOut': {
            ...
            'LocalDataProperty': {
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Path to property that is used to filter the value list with `startswith` comparison and filled from the picked value list item'
            },
            'InitialValueIsSignificant': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
        ...
        'ValueListParameterFilterOnly': {
            '$Kind': 'ComplexType',
            '$BaseType': 'com.sap.vocabularies.Common.v1.ValueListParameter',
            '@Org.OData.Core.V1.Description': 'Value list property that is used to filter the value list, not connected to the edited entity',
            '@Org.OData.Core.V1.Revisions': [
                {
                    'Kind': 'Deprecated',
        ...
        'IsCalendarYear': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a year number as string following the logical pattern (-?)YYYY(Y*) consisting of an optional\n            minus sign for years B.C. followed by at least four digits. The string matches the regex pattern -?([1-9][0-9]{3,}|0[0-9]{3})\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
        ...
        'IsCalendarHalfyear': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a halfyear number as string following the logical pattern H consisting of a single digit.\n            The string matches the regex pattern [1-2]\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsCalendarQuarter': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a calendar quarter number as string following the logical pattern Q consisting of a single digit.\n            The string matches the regex pattern [1-4]\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsCalendarMonth': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a calendar month number as string following the logical pattern MM consisting of two digits.\n            The string matches the regex pattern 0[1-9]|1[0-2]\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsCalendarWeek': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a calendar week number as string following the logical pattern WW consisting of two digits.\n            The string matches the regex pattern 0[1-9]|[1-4][0-9]|5[0-3]\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsDayOfCalendarMonth': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Day number relative to a calendar month. Valid values are between 1 and 31.\n          ',
        ...
        'IsDayOfCalendarYear': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Day number relative to a calendar year. Valid values are between 1 and 366.\n          ',
        ...
        'IsFiscalYear': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a fiscal year number as string following the logical pattern YYYY consisting of four digits.\n          The string matches the regex pattern [1-9][0-9]{3}\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsFiscalPeriod': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a fiscal period as string following the logical pattern PPP consisting of three digits.\n          The string matches the regex pattern [0-9]{3}\n          ',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsFiscalYearPeriod': {
        ...
        'IsFiscalQuarter': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a fiscal quarter number as string following the logical pattern Q consisting of a single digit.\n          The string matches the regex pattern [1-4]',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsFiscalYearQuarter': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a fiscal year and quarter as string following the logical pattern YYYYQ consisting of\n          five digits, where the last digit represents the quarter.\n          The string matches the regex pattern [1-9][0-9]{3}[1-4]',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsFiscalWeek': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Property encodes a fiscal week number as string following the logical pattern WW consisting of two digits.\n          The string matches the regex pattern 0[1-9]|[1-4][0-9]|5[0-3]',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsFiscalYearWeek': {
        ...
        'IsDayOfFiscalYear': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'Day number relative to a fiscal year. Valid values are between 1 and 371.',
            '@Org.OData.Core.V1.RequiresType': 'Edm.String',
            '@com.sap.vocabularies.Common.v1.MutuallyExclusiveTerm#DatePart': true
        },
        'IsFiscalYearVariant': {
        ...
        'MutuallyExclusiveTerm': {
            ...
            '$DefaultValue': true,
            '$AppliesTo': ['Term'],
            '@Org.OData.Core.V1.Description': 'Only one term of the group identified with the Qualifier attribute can be applied'
        },
        'OperationTemplate': {
            '$Kind': 'Term',
            ...
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'Qualified name of an operation that serves as template for the operation described by the annotated term or term property',
        ...
        'DraftRootType': {
            ...
            'PreparationAction': {
                ...
                '@Org.OData.Core.V1.LongDescription': 'The action is bound to the draft document root and has no parameters.'
            },
            'ActivationAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
            ...
            'EditAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.OperationTemplate': 'com.sap.vocabularies.Common.v1.Template_EditAction',
                '@Org.OData.Core.V1.Description': 'Action that creates an edit draft',
                '@Org.OData.Core.V1.LongDescription': 'The action is bound to the active document root node and has the signature of [`Template_EditAction`](#Template_EditAction).'
            },
            'ResumeAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Action that resumes a draft document. The action re-acquires the exclusive lock if needed and checks if the related active document was not changed concurrently',
                '@Org.OData.Core.V1.LongDescription': 'The action is bound to the draft document root and has no parameters.'
            },
            'NewAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.OperationTemplate': 'com.sap.vocabularies.Common.v1.Template_NewAction',
                '@Org.OData.Core.V1.Description': 'Action that creates a new draft',
                '@Org.OData.Core.V1.LongDescription': 'The action is bound to the draft document root entity set and has the signature of [`Template_NewAction`](#Template_NewAction).\n\nNew drafts may also be created by POSTing an entity with property `IsActiveEntity` = `false` (default) to the entity set.'
            },
            'AdditionalNewActions': {
                '$Collection': true,
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '@com.sap.vocabularies.Common.v1.OperationTemplate': 'com.sap.vocabularies.Common.v1.Template_NewAction',
                '@Org.OData.Core.V1.Description': 'Additional actions beside the default POST or standard `NewAction`that create a new draft',
                '@Org.OData.Core.V1.LongDescription': 'The actions are bound to the draft document root entity set and have the signature of [`Template_NewAction`](#Template_NewAction).'
            },
            'ShareAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.OperationTemplate': 'com.sap.vocabularies.Common.v1.Template_ShareAction',
                '@Org.OData.Core.V1.Description': 'Action that shares a draft document with other users and restricts access to the listed users in their specified roles',
                '@Org.OData.Core.V1.LongDescription': 'The action is bound to the draft document root node and has the signature of [`Template_ShareAction`](#Template_ShareAction).\nIt restricts access to the listed users in their specified roles.\n\nIf this action is present, the client can receive notifications about changes to the\ncollaborative draft by opening a web socket connection at the [`WebSocketBaseURL`](#WebSocketBaseURL)\nfollowed by URL parameters\n- `relatedService` = base URL (relative to server root) of the OData service of the app\n- `draft` = draft UUID.'
            }
        },
        'DraftNode': {
            '$Kind': 'Term',
            ...
            '@Org.OData.Core.V1.Description': 'Entities in this set are parts of business documents that support the draft pattern'
        },
        'DraftNodeType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Revisions': [
                {
                    'Kind': 'Deprecated',
                    'Description': 'The deprecated term [`DraftNode`](#DraftNode) effectively only tags the entity set, its value is an empty record'
                }
            ],
            'PreparationAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
            ...
            'ValidationFunction': {
                ...
                '@Org.OData.Core.V1.Description': 'Function that validates whether a draft document is ready for activation'
            }
        },
        'DraftActivationVia': {
            '$Kind': 'Term',
            '$Type': 'Org.OData.Core.V1.SimpleIdentifier',
            '$AppliesTo': ['EntitySet'],
            '@Org.OData.Core.V1.Description': 'Draft entities in this set are indirectly activated via draft entities in the referenced entity set'
        },
        'EditableFieldFor': {
            '$Kind': 'Term',
            '$Type': 'Edm.PropertyPath',
            '$AppliesTo': ['Property'],
            '@Org.OData.Core.V1.Description': 'The annotated property is an editable field for the referenced key property'
        },
        'SimpleIdentifier': {
            '$Kind': 'TypeDefinition',
            ...
            '@Org.OData.Core.V1.Revisions': [
                {
                    'Kind': 'Deprecated',
                    'Description': 'Use type [Core.SimpleIdentifier](https://github.com/oasis-tcs/odata-vocabularies/blob/main/vocabularies/Org.OData.Core.V1.md#SimpleIdentifier) instead'
                }
            ]
        },
        'QualifiedName': {
        ...
        'SemanticKey': {
            ...
            '$Type': 'Edm.PropertyPath',
            '$AppliesTo': ['EntityType'],
            '@Org.OData.Core.V1.Description': 'The listed properties form the semantic key, i.e. they are unique modulo IsActiveEntity'
        },
        'SideEffects': {
            '$Kind': 'Term',
        ...
        'SideEffectsType': {
            '$Kind': 'ComplexType',
            '@Org.OData.Core.V1.Description': 'Changes to the source properties or source entities may have side-effects on the target properties or entities.',
            '@Org.OData.Core.V1.LongDescription': 'If neither TargetProperties nor TargetEntities are specified, a change to the source property values may have unforeseeable side-effects.\nAn empty NavigationPropertyPath may be used in TargetEntities to specify that any property of the annotated entity type may be affected.\n\nSide effects without a `TriggerAction` happen immediately when modifying one of the source properties or source entities. Side effects with a `TriggerAction` are deferred until explicitly triggered via the `TriggerAction`.\n\nSpecial case where the side effect is annotated on an action: here the change trigger is the action invocation, so `SourceProperties` and `SourceEntities` have no meaning,\nonly `TargetProperties` and `TargetEntities` are relevant. They are addressed via the binding parameter of the action, e.g. if the binding parameter is named `_it`, all paths have to start with `_it/`.\nThis can also be used with OData V2 services: the annotation target is a function import that is marked with [`sap:action-for`](https://wiki.scn.sap.com/wiki/display/EmTech/SAP+Annotations+for+OData+Version+2.0#SAPAnnotationsforODataVersion2.0-Elementedm:FunctionImport), and all paths have to start with `_it/`.',
            'SourceProperties': {
                '$Collection': true,
                '$Type': 'Edm.PropertyPath',
                '@Org.OData.Core.V1.Description': 'Changes to the values of one or more of these structural properties may affect the targets'
            },
            'SourceEntities': {
                '$Collection': true,
                '$Type': 'Edm.NavigationPropertyPath',
                '@Org.OData.Core.V1.Description': 'Changes to one or more of these entities may affect the targets. An empty path means the annotation target.'
            },
            'SourceEvents': {
                '$Collection': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'When the service raises one or more of these "events for side effects", the targets may be affected'
            },
            'TargetProperties': {
                '$Collection': true,
                '@Org.OData.Core.V1.Description': 'These structural properties may be affected if the value of one of the sources changes',
                '@Org.OData.Core.V1.LongDescription': 'The syntax follows closely the syntax rules for `Edm.PropertyPath`, with the addition of `*` as the last path segment meaning all structural properties directly reached via the preceding path'
            },
            'TargetEntities': {
                '$Collection': true,
                '$Type': 'Edm.NavigationPropertyPath',
                '@Org.OData.Core.V1.Description': 'These entities will be affected if the value of one of the sources changes. All affected entities need to be explicitly listed. An empty path means the annotation target.'
            },
            'EffectTypes': {
                ...
                '@Org.OData.Core.V1.Description': 'One or more of the targets may show these effects. If not specified, any effect is possible.'
            },
            'TriggerAction': {
                '$Type': 'com.sap.vocabularies.Common.v1.QualifiedName',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Bound action to trigger side-effects after modifying an entity',
                '@Org.OData.Core.V1.LongDescription': 'Binding parameter type of the trigger action is the entity type annotated with `SideEffects`. The action does not have any additional parameters and does not return anything. It either succeeds with `204 No Content` or it fails with `4xx` or `5xx`.'
            },
            'Discretionary': {
                '$Type': 'Edm.Boolean',
                '$DefaultValue': false,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Indicates whether the client can decide if a side-effect should be triggered or not',
                '@Org.OData.Core.V1.LongDescription': 'The value of this property typically a static boolean value. It can be used by clients (e.g. by asking the end user) to decide if the side effect should be triggered or not. This indicator is only allowed in case a trigger action is given as only then the execution control of the side effect is provided to the client.'
            }
        },
        'EffectType': {
            '$Kind': 'EnumType',
        ...
        'FilterDefaultValueHigh': {
            ...
            '$Nullable': true,
            '$AppliesTo': ['Property'],
            '@com.sap.vocabularies.Common.v1.Experimental': 'Requested by Roland Trapp as a counterpart to CDS annotation @Consumption.filter.defaultValueHigh',
            '@Org.OData.Core.V1.Description': "A default upper limit for the property to be used in 'less than or equal' filter expressions."
        },
        'DerivedFilterDefaultValue': {
            '$Kind': 'Term',
            '$AppliesTo': ['Property'],
            '@com.sap.vocabularies.Common.v1.Experimental': 'This has been experimental for three years, consider to delete it',
            '@Org.OData.Core.V1.Description': 'Function import to derive a default value for the property from a given context in order to use it in filter expressions.',
        ...
        'SortOrderType': {
            ...
            'DynamicProperty': {
                '$Type': 'Edm.AnnotationPath',
                '$Nullable': true,
                '@Org.OData.Core.V1.Description': 'Dynamic property introduced by an annotation and used as sort property',
                '@Org.OData.Core.V1.LongDescription': 'If the annotation referenced by the annotation path does not apply to the same collection of entities\n            as the one being sorted according to the [`UI.PresentationVariant`](UI.md#PresentationVariant) or `Common.SortOrder` annotation,\n            this instance of `UI.PresentationVariant/SortOrder` or `Common.SortOrder` MUST be silently ignored.',
            ...
            'Expression': {
                ...
                '$Nullable': true,
                '@com.sap.vocabularies.Common.v1.Experimental': true,
                '@Org.OData.Core.V1.Description': 'Dynamic expression whose primitive result value is used to sort the instances'
            },
            'Descending': {
                '$Type': 'Edm.Boolean',
                '$Nullable': true,
        ...
        'OriginalProtocolVersion': {
            '$Kind': 'Term',
            '$AppliesTo': ['Schema'],
            '@Org.OData.Core.V1.Description': 'Original protocol version of a converted (V4) CSDL document, allowed values `2.0` and `3.0`'
        },
        'ApplyMultiUnitBehaviorForSortingAndFiltering': {
            ...
            '@Org.OData.Core.V1.Description': 'Sorting and filtering of amounts in multiple currencies needs special consideration',
            '@Org.OData.Core.V1.LongDescription': 'TODO: add link to UX documentation on https://experience.sap.com/fiori-design/'
        },
        'mediaUploadLink': {
            '$Kind': 'Term',
        ...
        'PrimitivePropertyPath': {
            ...
            '$AppliesTo': ['Term', 'Property'],
            '@com.sap.vocabularies.Common.v1.Experimental': true,
            '@Org.OData.Core.V1.Description': 'A term or term property with this tag whose type is (a collection of) `Edm.PropertyPath` MUST resolve to a primitive structural property'
        },
        'WebSocketBaseURL': {
            '$Kind': 'Term',
            '$AppliesTo': ['EntityContainer'],
