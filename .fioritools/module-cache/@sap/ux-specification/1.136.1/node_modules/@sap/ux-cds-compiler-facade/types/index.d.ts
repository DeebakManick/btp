...
declare module '@sap/cds-compiler-types' {
    ...
    export interface TokenStream {
        readonly tokens: ReadonlyArray<Token> | ReadonlyArray<TokenV6>;
        /**
         * @since cds compiler 6.0.0 which uses new parser
         */
        readonly lexer: {
            readonly input: string;
        };
        /**
         * @deprecated since cds compiler 6.0.0
         * @note use `tokenSource.lexer.input` instead
         */
    ...
    export interface XsnEnum extends XsnNamedObject {
        kind: 'enum';
        value?: {
            literal: string;
    ...
    export interface XsnTypedObject {
         ...
         */
        readonly items?: XsnTypedObject;
        readonly enum?: Record<string, XsnEnum>;
        readonly type?: {
            /**
    ...
    export interface XsnAnnotatedObject extends XsnNamedObject {
        ...
        /**
         * use to identify localized entities ($inferred = 'localized-entity')
         */
        readonly $inferred?: string;
