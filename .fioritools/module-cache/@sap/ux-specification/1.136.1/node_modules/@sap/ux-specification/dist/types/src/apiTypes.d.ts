...
export type ExportFPMCustomPageWithPathV4Parameters = ExportFPMCustomPageV4Parameters & {
    entityPath: ConfigEntityPath;
};
export type ExportFPMCustomPageV4 = {
    [SchemaType.FPMCustomPage]: ExportFPMCustomPageV4Parameters;
};
export type ExportFPMCustomPageWithPathV4 = {
    [SchemaType.FPMCustomPage]: ExportFPMCustomPageWithPathV4Parameters;
};
...
export type ExportParametersWithPathV4Type = ExportListReportWithPathV4 | ExportObjectPageWithPathV4 | ExportALPWithPathV4 | ExportFPMCustomPageWithPathV4;
...
export interface Specification {
    ...
    generateCustomExtension: (params: GenerateCustomExtensionParams) => Promise<Editor | undefined>;
    prompts: {
        api: PromptsAPI;
        types: PromptsType;
    };
