 ...
 * @param {string[]} _idBreadcrumbs Array of breadcrumb IDs used for identification
 * @param {string[]} _breadcrumbs Array of breadcrumb strings used for navigation or identification
 * @param {ControlTypeFunction} _controlType Function to determine the control type
 * @param title Title of the header section
 ...
 * @param {string} baseId Base Id of the control
 * @param {string[]} _idBreadcrumbs Array of breadcrumb IDs used for identification
 * @param {string[]} breadcrumbs Array of breadcrumb strings used for navigation or identification
 * @param {ControlTypeFunction} _controlType Function to determine the control type
 * @param title Title of the header section
 * @returns {string} stable ID of Object Page Header Action button
 */
