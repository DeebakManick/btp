...
import type { CustomActionOP } from './CustomAction';
...
export interface ObjectPageFormActions {
    [key: string]: FormAction | CustomFormActionOP | ObjectPageFormActionGroup;
}
export interface ObjectPageFormActionGroup {
    [id: string]: FormAction;
}
export {};
