 ...
 *
 * @param manifestSection - The section of the manifest containing color palette information.
 * @returns The processed color palette configuration.
 */
function importColorPalette(manifestSection) {
    ...
    if (Array.isArray(colorPalette)) {
        ...
        configPart = colorPalette;
        configPart.colorPaletteType = ux_specification_types_1.ColorPaletteDefinitionType.SemanticColoring;
    }
    else if (colorPalette['dimensionSettings']) {
        configPart = colorPalette;
        configPart.colorPaletteType = ux_specification_types_1.ColorPaletteDefinitionType.MapDimensionValues;
    }
    else {
        configPart = {
            colorPaletteType: ux_specification_types_1.ColorPaletteDefinitionType.StableColoring,
 ...
 * @param configPart - The configuration object containing the data to export.
 * @param key - The key identifying the specific configuration part.
 */
function exportColorPalette(manifestSection, configPart, key) {
    const value = JSON.parse(JSON.stringify(configPart[key]));
    delete value.colorPaletteType;
    if (configPart[key].colorPaletteType === ux_specification_types_1.ColorPaletteDefinitionType.StableColoring) {
...
], AnalyticalCardSettings.prototype, "bEnableStableColors", void 0);
