...
export declare const FE_NAMESPACE_V4 = "sap.fe";
...
export declare const FE_TEMPLATE_V4_ALP = "sap.fe.templates.AnalyticalListPage";
...
//# sourceMappingURL=sapUiPageV4.d.ts.map