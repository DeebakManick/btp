 ...
 * @param routingId - ID of the given page
 * @param configId - config id
 * @param viewId - view id in multi view mode
 */
 ...
 *
 * @param importParameters  - object comprising all input data
 * @param tableConfig - configuration object for the table or table view
 * @param factory - factory, for generating the access to reflect-metadata
 * @param pageType - page type
 * @param routingId - The unique identifier for the routing configuration in the manifest.
 * @param columnDefinitionName - The name of the column definition to be used.
 * @param viewId - The identifier for the specific view in multi-view mode.
 */
        ...
        for (const actionKey in actionsDefinition.properties) {
            ...
            if (typeof actionDefinition === 'object' && actionDefinition.$ref) {
                ...
                const importActionParams = {
                    ...
                    factory,
                    actionsInConfig: tableConfig.toolBar.actions,
                    actionKey,
...
/**
 * Transfer toolbar settings of list report.
 *
 * @param importParameters - Object comprising all input data for the import process.
 * @param config - The configuration object to be filled with imported settings.
 * @param factory - Factory instance for generating metadata access objects.
 * @param pageType - The type of the page being processed (e.g., ListReport or AnalyticalListPage).
 * @param routingId - The unique identifier for the routing configuration in the manifest.
 * @param columnDefinitionName - The name of the column definition to be used.
 * @param viewId - The identifier for the specific view in multi-view mode, if applicable.
 */
 ...
 * @param entitySet - The name of the entity set to be used for determining the target annotation
 ...
 * @param listReportPageConfig - the configuration object for the list report page
 * @param factory - factory, for generating the access to reflect-metadata
