sap.ui.define([
    ...
    return Controller.extend("taskbtp.taskbtp.controller.TaskBtp", {
        ...
        onSearch: function (sevent) {
            ...
            //     new sap.ui.model.Filter("number", "Contains", searchValue)
            //     // new sap.ui.model.Filter("numberUnit", "Contains", searchValue),
            //     // new sap.ui.model.Filter("statusText", "Contains", searchValue),
            //     // new sap.ui.model.Filter("weight", "Contains", searchValue)
            // ]});
             
            // this.getView().byId("RoyalEnfield").getBinding("items").filter(filters);
        // },
        
        
        onAscending:function(){
            this._sortDescending = false; // Force ascending sort
    ...
    this.getView().byId("RoyalEnfield").getBinding("items").sort(oSorter)
        ...
        onDescending:function(){
            this._sortDescending = true; // Force descending sort
            var oSorter = new sap.ui.model.Sorter("title", this._sortDescending);
            this.getView().byId("RoyalEnfield").getBinding("items").sort(oSorter)
        }
